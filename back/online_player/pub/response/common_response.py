...
class JSONResponse(JsonResponse):
    def __init__(self, data=None, status=None, http_status=None, error_head=None, error=None, extra=None, language='zh'):
        errors = None
        if error_head and error:
            errors = [error_head[0], error_head[1], error]
        context = {
        ...
        super().__init__(data=context, safe=False, status=http_status, json_dumps_params={'ensure_ascii': False})
        self['Access-Control-Allow-Origin'] = '*'
        self['Access-Control-Allow-Methods'] = 'POST, DELETE, PUT, GET, OPTIONS'
        self['Access-Control-Max-Age'] = '1000'
        self['Access-Control-Allow-Headers'] = '*'
